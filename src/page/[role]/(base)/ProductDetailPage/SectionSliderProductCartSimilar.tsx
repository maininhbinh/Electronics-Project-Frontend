...
import { useGetSimilarProductsQuery } from "../../(manager)/products/ProductsEndpoints";
import { IProduct } from "@/common/types/product.interface";
import { Empty, Skeleton } from "antd";
import { RadioChangeEvent } from "antd/lib";
import NcImage from "../shared/NcImage/NcImage";
import LoadingProduct from "../components/LoadingProduct";
export interface SectionSliderProductCardSimilarProps {
  className?: string
...
const SectionSliderProductCardSimilar: FC<SectionSliderProductCardSimilarProps> = ({
  ...
  const { data: dataItem } = useGetSimilarProductsQuery(idProduct);
...
export default SectionSliderProductCardSimilar;
